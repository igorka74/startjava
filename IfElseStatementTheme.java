    ...
    public static void main(String[] args) {
        ...
        if(sex != male) {
            System.out.println("Пол - женский");
                 } else {System.out.println("Пол - мужскойй\n");
                        }
        if(age > 18) {
            System.out.println("Можно водить машину");
                 } else {System.out.println("Нельзя водить машину\n");
                        }
        if(height < 1.8) {
            System.out.println("Рост не подходит для баскетбола");
                 } else {System.out.println("Рост подходит для баскетбола");
                        }
        if(firstNameLetter == 'М') {
            System.out.println("Возможно, вас зовут Михаил\n");
                 } else {System.out.println("Вас точно зовут не Михаил\n");
                        }
        ...
        if(isZero) {
            System.out.println("Число равно нолю\n");
                ...
                if(isEven) {System.out.println("Число " + num 
                    + " является положительным и четным\n");
                        }
                else {System.out.println("Число " + num + " является положительным и нечетным\n");
                    }
                }
                else {
                if(isEven) {System.out.println("Число " + num + " является отрицательным и четным\n");
                }
                else {System.out.println("Число " + num + " является отрицательным и нечетным\n");
                    }
                }
